...
public class TypeTranslationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_type_translation);

        activity=this;
        webV=(WebView)findViewById(R.id.webV);
        WebSettings webSettings = webV.getSettings();
        webV.loadUrl("file:///android_asset/web/play_tt.html");
        webV.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);
        webV.setVerticalScrollBarEnabled(true);
        webSettings.setDatabaseEnabled(true);
        webSettings.setDomStorageEnabled(true);
        webV.getSettings().setJavaScriptEnabled(true);
        webV.addJavascriptInterface(new TypeTranslationWebAppInterface(this), "Android");
        ...
        webV.setWebViewClient(new WebViewClient() {
            public void onPageFinished(WebView view, String url) {
                ...
                String tip_page_name = "type_translate";
...
class TypeTranslationWebAppInterface extends WebAppInterface {

    TypeTranslationActivity vc;

    public TypeTranslationWebAppInterface(Activity c) {
        super(c);
        vc=(TypeTranslationActivity)c;
    }

    @JavascriptInterface
    public void sToast(String str){vc.sToast(str);}
    ...
    @JavascriptInterface
    public void alemp(){ vc.sToast("Please type into the \'Translation\' field."); }
